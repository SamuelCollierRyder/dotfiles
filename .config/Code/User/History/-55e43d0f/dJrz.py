...
# 2. 
print(combined_df.loc[combined_df['GDP (output, multiple price benchmarks)'] < avg_gdp_2019) & (combined_df['Period life expectancy at birth - Sex: all - Age: 0'] > avg_life_exp_2019]))
