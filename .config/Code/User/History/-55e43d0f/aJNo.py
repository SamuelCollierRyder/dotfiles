...
# 1. 
print(life_expectancy_2019.loc[life_expectancy_2019['Period life expectancy at birth - Sex: all - Age: 0'] > avg_life_exp_2019+std_life_exp_2019 & life_expectancy_2019['Code'] != 'NaN'])
