...
x = combined_df.loc[(combined_df_capita['GDP per capita (output, multiple price benchmarks)'] < avg_gdp_capita_2019) & (combined_df['Period life expectancy at birth - Sex: all - Age: 0'] > avg_life_exp_2019)]
print(x)
